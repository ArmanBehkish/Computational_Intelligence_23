...
Included_lists = filter(lambda item:type(item) is list,Included)
weight = sum([len(item) for item in list(Included_lists)])
print("included: ", list(Included_lists), "weight:" , weight)
